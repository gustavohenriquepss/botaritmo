...
const Discover = () => {
  ...
  return <div className="min-h-screen bg-white">
      <SEOHead title="Descobrir Eventos" description="Explore eventos populares perto de você, navegue por categoria ou confira alguns dos ótimos calendários da comunidade." keywords="eventos, descobrir eventos, eventos da comunidade, eventos locais, calendário de eventos" />
      ...
      <RotatingBadge text="TAONDE?" onClick={scrollToEvents} showIcon={true} icon={<img src={arrowDown} alt="Seta para baixo" className="w-6 h-6 md:w-7 md:h-7 lg:w-12 lg:h-12" />} />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          animationFillMode: 'both'
            ...
            <div className="flex items-center">
              <span className="border border-black px-3 md:px-6 py-2 md:py-4 animate-fade-in" style={{
              animationDelay: '0.3s',
              animationFillMode: 'both'
            }}>Os melhores</span>
              <span style={{
              animationDelay: '0.4s',
              animationFillMode: 'both'
            }} className="bg-brand border border-black px-3 py-2 md:py-4 rounded-[500px] md:rounded-[40px] -ml-px animate-fade-in md:px-[30px]">eventos</span>
            </div>
            <div className="flex items-center -mt-px">
              ...
              <span className="border border-l-0 border-black px-3 md:px-6 py-2 md:py-4 animate-fade-in" style={{
              animationDelay: '0.6s',
              animationFillMode: 'both'
            }}>{"<3"}</span>
            </div>
      ...
      <section id="events-section" className="px-4 md:px-8 pb-16 pt-6 md:pt-16">
        <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8 lg:gap-12 mt-8 md:mt-16">
            ...
            <div className="hidden lg:block animate-fade-in lg:sticky lg:top-24 self-start" style={{
            animationDelay: '0.9s',
            animationFillMode: 'both'
          }}>
