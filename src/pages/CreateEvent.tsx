...
const CreateEvent = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!imageFile) {
      toast.error('Por favor, adicione uma imagem do evento');
      return;
    }
    ...
    if (endDateTime <= startDateTime) {
      toast.error('Data/hora de término deve ser após a data/hora de início');
      return;
    }
    ...
    try {
      ...
      toast.error('Falha ao criar evento. Por favor, tente novamente.');
    } finally {
  ...
  return (
    <>
      <SEOHead 
        title="Criar Evento"
        description="Crie e publique um novo evento para a comunidade descobrir e participar"
      />
